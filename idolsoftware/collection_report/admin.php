...
?>
					<div class="row filter-row">
						...
						<div class="col-sm-3 col-xs-6">  
                        <div class="form-group ">
							<button class="btn btn-primary" style="margin-top:20px;" type="button" onClick="get_collection_report(emp_id.value,from_date.value,to_date.value)">View Report</button>
                            </div>
						</div>     
                    </div>
					<div class="row">
						<div class="col-md-12">
							 <div id="collection_report_div"> <?php include('admin_list.php') ?>
						</div>
					</div>
                </div>
 ...
 <script>
function get_collection_report(emp_id,from_date,to_date)
{
jQuery.ajax({
type: "POST",
url: "collection_report/admin_list.php",
data: "emp_id="+emp_id+"&from_date="+from_date+"&to_date="+to_date,
success: function(data) {
jQuery("#collection_report_div").html(data);
}
});
}
</script>