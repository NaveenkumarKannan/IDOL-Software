        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-4">
							<h4 class="page-title">Check -In Report</h4>
						</div>
...
?>
					<div class="row filter-row">
						...
						<div class="col-sm-3 col-xs-6">  
                        <div class="form-group ">
							<button class="btn btn-primary" style="margin-top:20px;" type="button" onClick="get_checkin_report(emp_id.value,from_date.value,to_date.value)">View Report</button>
                            </div>
						</div>     
                    </div>
					...
					<div class="row">
						<div class="col-md-12">
							 <div id="checkin_report_div"> <?php include('admin_list.php') ?>
						</div>
					</div>
                </div>
    ...
    <script>
function get_checkin_report(emp_id,from_date,to_date)
{
jQuery.ajax({
type: "POST",
url: "checkin report/admin_list.php",
data: "emp_id="+emp_id+"&from_date="+from_date+"&to_date="+to_date,
success: function(data) {
jQuery("#checkin_report_div").html(data);
}
});
}
</script>